...
export interface Session {id:string; project_id:string; name:string; messages:Message[]; commands:CommandResult[]; created_at:string; updated_at:string; pinned?:boolean; archived?:boolean; queue?:QueuedMessage[]; worktree?:{path:string;branch:string}|null}
