...
export interface Model {id:string; name:string; provider:string; model_name:string; account:string|null; base_url:string|null; input_price:number|null; output_price:number|null; key_hint:string; status:string; latency_ms?:number; capabilities?:Record<string,number>|null; cost_class?:string|null; enabled?:boolean; online?:boolean|null; track?:string; benchmark?:string|null}
